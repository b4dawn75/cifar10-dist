...
"""Builds the CIFAR-10 nework.

Summary of available functions:

 # Compute input images and labels for training. If you like to run
 # evaluation, use inputs() instead.
...
NUM_EXMAPLES_PER_EPOCH_FOR_EVAL = cifar10_input.NUM_EXAMPLES_PER_EPOCH_FOR_EVAL
...
def inputs(eval_data):
    ...
    Args:
        eval_data: bool, indicating if one should use the train or eval data
            set.
...
def inference(images):
    ...
    # tf.Variables() in order to share variables across multiple GPU training
...
def loss(logits, labels):
    ...
    Args:
        ...
        Labels: Labels from distorted_inputs or inputs(). 1D tensor
                of shape [batch_size]
...
def _add_loss_summaries(total_loss):
    ...
    Generates moving averages for all losses and associated summaries for
...
def train(total_loss, global_step):
    ...
    num_batches_per_epoch = \
        NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN / FLAGS.batch_size
    ...
    # Generate moving average of all losses and associated summaries.
