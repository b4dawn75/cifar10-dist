...
def tower_loss(scope):
    ...
    # total_loss_print = tf.Print(total_loss, [total_loss], message="Total Loss: ")
    ...
    for l in losses + [total_loss]:
        ...
        # taining session. This helps the clarity of presentation on
        # tensorboard.
...
def train():
    ...
    with tf.Graph().as_default(), tf.device('/cpu:0'):
        ...
        # Start running operations on the Graph. allow_soft_placement must set
        # to Ture to build towers on GPU, as some of the ops do not have GPU
        # implementations.
