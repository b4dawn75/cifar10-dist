...
def read_cifar10(filename_queue):
    ...
    # Dimensions of the iamges in the CIFAR-10 dataset.
    ...
    # footer_bytes at their default on 0.
    ...
    # The first bytes represent the label, which we convert from uint8->uint32
...
def distorted_inputs(data_dir, batch_size):
    ...
    # distortion applies to the image.

    # Randomly crop a [height, width] section of the image.
    distorted_image = tf.random_crop(reshaped_image, [height, width, 3])

    # Randomly flip the image horizontly.
